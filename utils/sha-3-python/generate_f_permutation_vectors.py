...
def generate_header(vectors: list, output_path: str):
    with open(output_path, "w") as f:
        ...
        f.write("// =======================\n")
        f.write("// These test vectors use LITTLE-ENDIAN lane format per Keccak specification.\n")
        f.write("//\n")
        f.write("// Example: SHA3-256('abc') produces the first 64-bit lane as:\n")
        f.write("//   in_words[0] = 0x00000000    (upper 32 bits)\n")
        f.write("//   in_words[1] = 0x06636261    (lower 32 bits)\n")
        f.write("//   Combined lane: 0x00000000_06636261\n")
        f.write("//\n")
        f.write("//   Byte breakdown (little-endian):\n")
        ...
        f.write("//   expected_out[50] : MSB-first; expected_out[0] = state[1599:1568]\n")
        ...
        for i, v in enumerate(vectors):
            ...
            f.write("        // in_words[0..35], MSB first (little-endian Keccak lane format)\n")
            f.write("        {\n")
